...
const WEBSITE_PIN = "00010";              // ← GANTI PIN

/* ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
   2. NAMA PENERIMA
   ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
   Nama yang muncul di halaman utama (hero).                      */
const RECIPIENT_NAME = "MAS HANIIP";           // ← GANTI NAMA
...
const MUSIC_TRACKS = [
  {
    title:  "Rewrite the Stars",             // ← GANTI JUDUL LAGU
    artist: "James Arthur",                   // ← GANTI NAMA ARTIS
...
const LETTER_PARAGRAPHS = [
  "Entah kenapa, buat banyak orang tanggal 23 February mungkin cuma hari biasa. Tapi buat aku, tanggal itu selalu punya arti yang beda. Karena di tanggal itulah pertama kali kita chat, pertama kali semesta ngasih aku kesempatan buat kenal sama kamu. Dan sejak saat itu, ada banyak hal yang berubah tanpa aku sadari.",
  "Makanya setiap tanggal 23 February selalu jadi hari yang aku inget. Bukan karena ada perayaan besar atau sesuatu yang spesial buat orang lain, tapi karena hari itu adalah awal dari semua cerita yang pernah kita punya. Hari di mana semuanya dimulai, dari chat sederhana sampai kenangan yang sekarang masih aku simpan baik-baik.",
  "Mungkin kamu nggak sadar, tapi buat aku tanggal itu selalu punya tempat sendiri di hati. Setiap tahunnya aku selalu keinget gimana semuanya bermula. Keinget rasa seneng waktu nunggu balasan chat kamu, keinget obrolan-obrolan random kita, dan keinget semua hal kecil yang ternyata jadi berarti seiring berjalannya waktu.",
  "Jadi kalau suatu hari nanti ada yang nanya kenapa aku selalu inget tanggal 23 February, jawabannya sederhana. Karena itu adalah hari di mana aku dipertemukan sama seseorang yang berhasil ninggalin jejak besar dalam hidup aku. Dan sampai kapan pun, tanggal itu bakal selalu jadi salah satu tanggal favorit yang nggak pernah mau aku lupain. 🤍",
];
